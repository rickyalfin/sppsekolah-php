...
while($sq = mysqli_fetch_assoc($sql)){
	echo "
		...
		<tr>
			...
			<td align='center'";
				if ($sq['nobayar'] == ''){
					echo "<a   href='proses_transaksi_user.php?nis=$nis&act=bayar&id=$sq[idspp]'></a> ";
					echo "<a class='btn btn-primary btn-sm' href='proses_transaksi_user.php?nis=$nis&act=bayar&id=$sq[idspp]'>Bayar</a> ";
				}else {
					echo "</a>";
